...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Oct 2024 17:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Oct 2024 17:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Oct 2024 17:00:00.000000000
        Stop		 1 Mar 2025 17:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Oct 2024 17:00:00.000000000
...
"1 Oct 2024 17:00:00.000000000" "1 Mar 2025 17:00:00.000000000"
                        END Intervals
            ...
            WindowRectLeft		 1024
            WindowRectTop		 755
            WindowRectRight		 1223
            WindowRectBottom		 802
        END Report
...
"1 Oct 2024 17:00:00.000000000" "1 Mar 2025 17:00:00.000000000"
        ...
        BEGIN Report
            Name		 TLE Solution Summary
            Type		 Report
            BaseDir		 Install
            Style		 TLE Solution Summary
            AGIViewer		 Yes
            Instance		 Satellite/Cubesat
            BEGIN TimeData
                BEGIN Section
...
"1 Oct 2024 17:00:00.000000000" "8 Oct 2024 17:00:00.000000000"
                        END Intervals
...
"1 Oct 2024 17:00:00.000000000" "1 Mar 2025 17:00:00.000000000"
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 -122256000
            LaunchWindowStop		 -135216000
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 16 Nov 2020 17:00:00.000000000
                    Stop		 17 Nov 2020 17:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<SCOPE>
    <VAR name = "ClutterMap">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Oct 2024 17:00:00.000000000
                EndTime		 1 Mar 2025 17:00:00.000000000
                CurrentTime		 2 Oct 2024 05:15:00.000000000
                Mode		 Stop
                Direction		 Forward
                UpdateDelta		 300
                RefreshDelta		 HighSpeed
                XRealTimeMult		 1296000
                RealTimeOffset		 0
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Facility/Wallops
            Facility/Wallops		
            Facility/Wallops/Receiver/Receiver1		
        END Instance
        Instance Facility/Wallops/Receiver/Receiver1
            Facility/Wallops/Receiver/Receiver1		
        END Instance
        Instance Place/SSU
            Place/SSU		
        END Instance
        Instance Place/UniSMaine
            Place/UniSMaine		
        END Instance
        Instance Satellite/Cubesat
            *		
        ...
        Instance Satellite/Cubesat/Transmitter/Transmitter1
            Satellite/Cubesat/Transmitter/Transmitter1		
        END Instance
        Instance Satellite/Cubesat_SGP4
            Satellite/Cubesat_SGP4		
        END Instance
